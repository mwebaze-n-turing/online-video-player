        ...
        <div className="flex items-center justify-end space-x-2">
          ...
          <div className="group relative flex items-center">
            <button
              ...
              className="flex items-center justify-center w-9 h-9 rounded-full bg-black/50 hover:bg-gray-800/80 active:bg-gray-700/90 transition-all duration-150 hover:scale-110 active:scale-90 focus:outline-none focus:ring-2 focus:ring-white/50 z-10"
            ...
            {/* Volume slider with expanding animation */}
            <div className="absolute left-7 w-0 overflow-hidden opacity-0 group-hover:w-20 group-hover:opacity-100 transition-all duration-300 bg-black/70 rounded-full px-2 py-1">
              <input
                type="range"
                min="0"
                max="1"
                ...
                className="w-full accent-primary appearance-none h-1 bg-white/30 rounded-full outline-none cursor-pointer 
                hover:accent-primary-bright focus:outline-none focus:ring focus:ring-primary-bright/50"
                aria-label="Volume"
              />
            </div>
          </div>
